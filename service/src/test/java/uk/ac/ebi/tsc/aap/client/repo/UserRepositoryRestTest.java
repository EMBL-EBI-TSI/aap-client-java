...
@TestPropertySource(properties = {"aap.domains.url=domainAPI", "aap.timeout=5000"})
public class UserRepositoryRestTest {
	...
	can_create_local_account() {
		...
		this.usersApi.expect(requestTo("domainAPI/auth")).andExpect(method(HttpMethod.POST))
